...
class MyThirdAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyThirdAdapter.ViewHolder {
        val item = LayoutInflater.from(parent.context).inflate(R.layout.item_view, parent, false)
        return ViewHolder(item)
    }

    override fun onBindViewHolder(holder: MyThirdAdapter.ViewHolder, position: Int) {
